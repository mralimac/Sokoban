...
public abstract class MoveableTile extends Tile{
	...
	private Rectangle getObjectInGridPane(int xCoord, int yCoord)
	{
	...
	public boolean generalMovementHandler(int xCoord, int yCoord, int direction)
	{
		...
		if(isCrateInWay(xCoord, yCoord, direction))
		{
			...
			else
			{
				...
				break;
				case 3: directionString = "South";
				break;
				case 4: directionString = "West";
				}
				System.out.println("The crate cannot move " + directionString);
				return false;
			}
		}
		...
		{	
			...
			System.out.println("The Player may not move " + directionString);
			return false;
		}
	...
	private boolean canCrateMove(int xCoord, int yCoord, int direction)
	{
		switch(direction)
		{
	...
	private boolean doWeNeedToPlaceADiamond(int xCoord, int yCoord)
	{
	...
	private void moveCrate(int xCoord, int yCoord, int direction)
	{
		switch(direction)
		{
		case 1: yCoord--;
	...
	private boolean isCrateInWay(int xCoord, int yCoord, int direction)
	{
		switch(direction)
		{
		case 1: yCoord--;
	...
	private boolean isDirectionPossible(int xCoord, int yCoord, int direction)
	{
